        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Descrestion = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SeoAlias = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DateCreated = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 6, 28, 1, 19, 27, 140, DateTimeKind.Local).AddTicks(5208)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 6, 28, 1, 19, 27, 141, DateTimeKind.Local).AddTicks(2686)),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateCeated = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 6, 28, 1, 19, 27, 140, DateTimeKind.Local).AddTicks(7857))
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "/img/categories/cat-1.0.jpg", "Thịt", "#" },
                    { 2, "/img/categories/cat-2.0.jpg", "Hải sản", "#" },
                    { 3, "/img/categories/cat-3.0.jpg", "Trứng", "#" },
                    { 4, "/img/categories/cat-4.0.jpg", "Đồ ăn nhanh", "#" },
                    { 5, "/img/categories/cat-5.0.jpg", "Sữa - Nước uống", "#" },
                    { 6, "/img/categories/cat-6.0.jpg", "Rau củ", "#" },
                    { 7, "/img/categories/cat-7.0.jpg", "Trái cây", "#" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "Descrestion", "IsFeatured", "Name", "Price", "SeoAlias", "Stock" },
                values: new object[] { 1, 1, "Thịt ba rọi khay", true, "Thịt ba rọi khay", 89300, "thit-ba-roi-khay", 50 });
